...
namespace BCC.MSBuildLog.Legacy.MSBuild.Services
{
    public class BuildLogProcessor : IBuildLogProcessor
    {
        ...
        public void Process(string inputFile, string outputFile, string cloneRoot, string owner, string repo, string hash, string configurationFile = null)
        {
            ...
            var configuration = LoadCheckRunConfiguration(_fileSystem, configurationFile);
        ...
        public static CheckRunConfiguration LoadCheckRunConfiguration(IFileSystem fileSystem, string configurationFile)
        {
